...
export default function ProductCard({ title, isLoved }) {
  ...
  return (
    <div 
        ...
        className=" w-[8.5rem] sl:w-40 h-56 sl:h-60 bg-white shrink-0 rounded-xl mb-7 shadow-xl shadow-zinc-600/30"
    >
      <div className="w-full h-36 sl:h-40 rounded-xl bg-[#E8D5B7] clipInverse"></div>
